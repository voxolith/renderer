/**
 * A WebGPU voxel raymarching engine. Public API barrel.
 *
 ...
 * shader imports, which only a bundler can resolve. Consumers compile the raw
 * TypeScript sources, and a Vite app lists the package in
...
export type { GpuContext, GpuOptions, GrantedLimits, AdapterInfo, UnsupportedOpts } from "./device";
